...
public class ProductOfArrayExceptSelf238Test {
    ...
    void ProductOfArrayExceptSelf238Test1() {
        assertThat(ProductOfArrayExceptSelf238.productExceptSelfWithExtraSpace(new int[]{1, 2, 3, 4}))
                .isEqualTo(new int[]{24, 12, 8, 6});
    }

    @Test
    void ProductOfArrayExceptSelf238Test2() {
        assertThat(ProductOfArrayExceptSelf238.productExceptSelfWithInPlace(new int[]{-1, 1, 0, -3, 3}))
