 ...
 * 3.
 * Временная сложность: O(N), где N - количество элементов в массиве nums (проходимся по нему два раза).
 * Пространственная сложность: O(N), в худшем случае (если дубликат в конце), в set добавятся n - 1 уникальных чисел
 */
